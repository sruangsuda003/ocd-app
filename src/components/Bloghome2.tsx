                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    ...
                    <p className="card-text">
                      ...
                      จะต้องนำเทคโนโลยีดิจิทัลและเทคโนโลยีปัญญาประดิษฐ์มาใช้ในการบริหารจัดการองค์การ
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    ...
                    <p className="card-text">
                      ...
                      เพื่อการเปลี่ยนแปลงและการพัฒนาองค์การภาครัฐ
                    </p>
                    <a
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    ...
                    <p className="card-text">
                      ...
                      เพื่อการเปลี่ยนแปลลงและการพัฒนาภาครัฐในยุคดิจิทัล
                    </p>
                    <a
              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    ...
                    <p className="card-text">
                      ลักษณะสำคัญขององค์การ คือ ภาพรวมของส่วนราชการ
                      สิ่งสำคัญที่มีอิทธิพลต่อการดำเนินงาน
                      และความท้าทายสำคัญที่ส่วนราชการเผชิญอยู่
                      เพื่อการพัฒนาคุณภาพการบริหารจัดการภาครัฐในยุคดิจิทัล
                    </p>
                    <a
